...
export default function MdpOResetCampoo(props) {
		...
		<SafeAreaView style={styles.container}>
			...
			<View style={styles.PswdView}>
				<View>
					...
					<InputCampooSignup secure={true} value={props.password} onChangeText={(text) => setPassword(text)} style={styles.InputView1} errorText={errorMessage} />
				</View>

				<View>
					<LabelCampoo style={styles.Pswd2}>Vérification</LabelCampoo>

					<InputCampooSignup secure={true} value={props.confirmPassword} onChangeText={(text) => setConfirmPassword(text)} style={styles.InputView2} errorText={errorMessages} />
				</View>

				<ButtonCampoo style={styles.button} onPress={() => onSubmit()}>
					Suivant
				</ButtonCampoo>

				<SecondaryButtonCampoo style={styles.retour} onPress={() => props.navigation.goBack()}>
					Retour
				</SecondaryButtonCampoo>
			</View>
		</SafeAreaView>
	);
}
