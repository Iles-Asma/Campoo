...
async function withTypeScriptAsync(webpackConfig, env = {}) {
    ...
    try {
        typeScriptPath = config_1.resolveModule('typescript', env.projectRoot, {
            nodeModulesPath: (_a = env.config) === null || _a === void 0 ? void 0 : _a.nodeModulesPath,
        });
    }
    catch (_) { }
    ...
    if (!isTypeScriptEnabled && ((_b = webpackConfig.resolve) === null || _b === void 0 ? void 0 : _b.extensions)) {
