...
async function addToPathAsync(name) {
  ...
  const ignoreBundledBinaries = await _UserSettings().default.getAsync('ignoreBundledBinaries', []);
...
async function writePathToUserSettingsAsync() {
  ...
  const pathFile = _path().default.join(_UserSettings().default.dotExpoHomeDirectory(), 'PATH');
