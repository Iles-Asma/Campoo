...
export declare function validateWithSchema(projectRoot: string, { _internal, ...exp }: ExpoConfig, schema: any, configName: string, validateAssets: boolean): Promise<{
...
declare type ExpoSdkStatus = 0 | 1 | 2;
export declare const EXPO_SDK_INSTALLED_AND_IMPORTED = 0;
export declare const EXPO_SDK_NOT_INSTALLED = 1;
export declare const EXPO_SDK_NOT_IMPORTED = 2;
export declare function getExpoSdkStatus(projectRoot: string): Promise<ExpoSdkStatus>;
