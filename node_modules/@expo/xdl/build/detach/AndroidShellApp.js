...
async function runShellAppModificationsAsync(context, sdkVersion, buildMode) {
  ...
  await regexFileAsync('"app_name">Expo Go<', `"app_name">${xmlWeirdAndroidEscape(name)}<`, _path().default.join(shellPath, 'app', 'src', 'main', 'res', 'values', 'strings.xml')); // Splash Screen background color
