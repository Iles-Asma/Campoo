...
async function _maybeWriteArtifactsToDiskAsync(config) {
  var _exp$android, _exp$android2, _exp$android3, _exp$ios, _exp$ios2, _exp$ios3;
  ...
  if ((_exp$android = exp.android) === null || _exp$android === void 0 ? void 0 : _exp$android.publishBundlePath) {
    androidBundlePath = exp.android.publishBundlePath;
  }

  if ((_exp$android2 = exp.android) === null || _exp$android2 === void 0 ? void 0 : _exp$android2.publishManifestPath) {
    androidManifestPath = exp.android.publishManifestPath;
  }

  if ((_exp$android3 = exp.android) === null || _exp$android3 === void 0 ? void 0 : _exp$android3.publishSourceMapPath) {
    androidSourceMapPath = exp.android.publishSourceMapPath;
  }

  if ((_exp$ios = exp.ios) === null || _exp$ios === void 0 ? void 0 : _exp$ios.publishBundlePath) {
    iosBundlePath = exp.ios.publishBundlePath;
  }

  if ((_exp$ios2 = exp.ios) === null || _exp$ios2 === void 0 ? void 0 : _exp$ios2.publishManifestPath) {
    iosManifestPath = exp.ios.publishManifestPath;
  }

  if ((_exp$ios3 = exp.ios) === null || _exp$ios3 === void 0 ? void 0 : _exp$ios3.publishSourceMapPath) {
