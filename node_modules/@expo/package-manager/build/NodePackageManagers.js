...
class NpmPackageManager {
    constructor({ cwd, log, silent }) {
        ...
        this.options = Object.assign({ env: Object.assign(Object.assign({}, process.env), disableAdsEnv), cwd }, (silent
            ? { ignoreStdio: true }
            : {
    ...
    async _runAsync(args) {
        ...
        const promise = spawn_async_1.default('npm', [...args], Object.assign(Object.assign({}, this.options), { ignoreStdio: false }));
...
class YarnPackageManager {
    ...
    async _runAsync(args) {
        ...
        // Have spawnAsync consume stdio but we don't actually do anything with it if it's ignored
        const promise = spawn_async_1.default('yarnpkg', args, Object.assign(Object.assign({}, this.options), { ignoreStdio: false }));
        if (promise.child.stderr && !this.options.ignoreStdio) {
