...
async function osascriptExecAsync(script, opts) {
    return await exec_async_1.default('osascript', osascriptArgs(script), Object.assign({ stdio: 'inherit' }, opts));
}
exports.execAsync = osascriptExecAsync;
async function osascriptSpawnAsync(script, opts) {
    return await spawn_async_1.default('osascript', osascriptArgs(script), opts);
}
