...
async function ejectAsync(projectRoot, options) {
  ...
  const questions = {
    type: 'select',
    name: 'ejectMethod',
    message: `How would you like to eject your app?\n  ${_chalk().default.dim((0, _TerminalLink().learnMore)('https://docs.expo.io/expokit/eject/'))}`,
    choices: [{
      title: reactNativeOptionMessage,
      value: 'bare'
    }, {
      title: "ExpoKit: I'll create or log in with an Expo account to use React Native and the Expo SDK.",
      value: 'expokit'
    }, {
  ...
  const ejectMethod = options.ejectMethod || (await (0, _prompts().default)(questions, {
