...
function getAppLookupParams(experienceName, bundleIdentifier) {
  ...
  (0, _assert().assert)(matchedExperienceName && matchedExperienceName.length >= 3, 'invalid experience name');
  return {
...
class IosApi {
  ...
  async createDistCert(accountName, credentials) {
    ...
    (0, _assert().assert)(id && distCert, 'distribution certificate does not exists');
    (0, _assert().assert)(distCert.type === 'dist-cert', 'wrong type of user credential');
    return distCert;
  }
  ...
  async updateDistCert(id, accountName, credentials) {
    ...
    (0, _assert().assert)(distCert, 'distribution certificate does not exists');
    (0, _assert().assert)(distCert.type === 'dist-cert', 'wrong type of user credential');
    return distCert;
  }
  ...
  async createPushKey(accountName, credentials) {
    ...
    (0, _assert().assert)(id && pushKey, 'push key does not exists');
    (0, _assert().assert)(pushKey.type === 'push-key', 'wrong type of user credentials');
    return pushKey;
  }
  ...
  async deleteProvisioningProfile(appLookupParams) {
    ...
    if (appCredentials === null || appCredentials === void 0 ? void 0 : appCredentials.credentials) {
  ...
  removeUserCredentialFromCache(id, accountName) {
    ...
    if ((_this$credentials$acc27 = this.credentials[accountName]) === null || _this$credentials$acc27 === void 0 ? void 0 : (_this$credentials$acc28 = _this$credentials$acc27.userCredentials) === null || _this$credentials$acc28 === void 0 ? void 0 : _this$credentials$acc28[String(id)]) {
  ...
  async ensureAppCredentials(appLookupParams) {
    ...
    if (this.isPrefetched[accountName] || ((_this$credentials2 = this.credentials) === null || _this$credentials2 === void 0 ? void 0 : (_this$credentials2$ac = _this$credentials2[accountName]) === null || _this$credentials2$ac === void 0 ? void 0 : (_this$credentials2$ac2 = _this$credentials2$ac.appCredentials) === null || _this$credentials2$ac2 === void 0 ? void 0 : _this$credentials2$ac2[appCredentialsIndex])) {
      return;
    }
