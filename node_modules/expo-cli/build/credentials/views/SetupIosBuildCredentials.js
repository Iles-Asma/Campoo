...
class SetupIosBuildCredentialsFromLocal {
  ...
  async open(ctx) {
    ...
    const distCert = await ctx.ios.getDistCert(this.app);
    const appsUsingCert = (distCert === null || distCert === void 0 ? void 0 : distCert.id) ? (credentials.appCredentials || []).filter(cred => cred.distCredentialsId === distCert.id) : [];
    ...
    if (appsUsingCert.length > 1 && (distCert === null || distCert === void 0 ? void 0 : distCert.id)) {
      const {
        update
    ...
    } else if (distCert === null || distCert === void 0 ? void 0 : distCert.id) {
      await ctx.ios.updateDistCert(distCert.id, this.app.accountName, newDistCert);
    } else {
      const createdDistCert = await ctx.ios.createDistCert(this.app.accountName, newDistCert);
      await ctx.ios.useDistCert(this.app, createdDistCert.id);
