...
async function updateAndroidCredentialsAsync(ctx) {
  ...
  (0, _log().default)(`Writing Keystore to ${keystorePath}`);
...
async function updateIosCredentialsAsync(ctx, bundleIdentifier) {
  ...
  if (!(appCredentials === null || appCredentials === void 0 ? void 0 : (_appCredentials$crede = appCredentials.credentials) === null || _appCredentials$crede === void 0 ? void 0 : _appCredentials$crede.provisioningProfile) && !distCredentials) {
    _log().default.error('There are no credentials configured for this project on Expo servers');
  ...
  (0, _log().default)(`Writing Provisioning Profile to ${pprofilePath}`);
  ...
  (0, _log().default)(`Writing Distribution Certificate to ${distCertPath}`);
  ...
  rawCredentialsJsonObject.ios = { ...((appCredentials === null || appCredentials === void 0 ? void 0 : (_appCredentials$crede4 = appCredentials.credentials) === null || _appCredentials$crede4 === void 0 ? void 0 : _appCredentials$crede4.provisioningProfile) ? {
      provisioningProfilePath: pprofilePath
    } : {}),
    ...((distCredentials === null || distCredentials === void 0 ? void 0 : distCredentials.certP12) && (distCredentials === null || distCredentials === void 0 ? void 0 : distCredentials.certPassword) ? {
