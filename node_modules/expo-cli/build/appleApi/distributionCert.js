...
async function listDistributionCertificatesAsync(authCtx) {
  const spinner = (0, _ora().default)(`Fetching Apple distribution certificates`).start();
...
async function createDistributionCertificateAsync(authCtx) {
  const spinner = (0, _ora().default)(`Creating Apple distribution certificate`).start();
...
async function revokeDistributionCertificateAsync(authCtx, ids) {
  ...
  const spinner = (0, _ora().default)(`Revoking ${name}`).start();
