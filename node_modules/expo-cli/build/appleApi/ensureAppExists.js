...
async function ensureBundleIdExistsWithNameAsync(authCtx, {
  ...
  let spinner = (0, _ora().default)(`Linking bundle identifier ${_chalk().default.dim(bundleIdentifier)}`).start();
  let bundleId;
  ...
  if (options) {
    try {
      spinner = (0, _ora().default)(`Syncing capabilities`).start(); // Update the capabilities
