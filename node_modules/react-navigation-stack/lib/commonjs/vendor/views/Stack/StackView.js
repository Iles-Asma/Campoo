...
class StackView extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "handleTransitionEnd", ({
      ...
      const descriptor = descriptors[route.key] || this.state.descriptors[route.key];
      descriptor === null || descriptor === void 0 ? void 0 : (_descriptor$options$o2 = (_descriptor$options2 = descriptor.options).onTransitionStart) === null || _descriptor$options$o2 === void 0 ? void 0 : _descriptor$options$o2.call(_descriptor$options2, {
        closing
      });
    });
  ...
  render() {
    ...
    }, props => /*#__PURE__*/React.createElement(_HeaderShownContext.default.Consumer, null, isParentHeaderShown => /*#__PURE__*/React.createElement(_CardStack.default, _extends({
      mode: mode,
      insets: insets,
